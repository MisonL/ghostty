...
#define GHOSTTY_RUNTIME_CONFIG_VERSION 2u
#define GHOSTTY_RUNTIME_CONFIG_SIZE ((uint32_t)sizeof(ghostty_runtime_config_s))
#define GHOSTTY_RUNTIME_CONFIG_MIN_SIZE ((uint32_t)offsetof(ghostty_runtime_config_s, software_frame_storage_support))
...
ghostty_runtime_config_s ghostty_runtime_config_new(void);
