...
pub fn OverlayModule() type {
    return struct {
        ...
        pub const Color = enum {
            ...
            pub fn rgb(self: @This()) z2d.pixel.RGB {
                return switch (self) {
            ...
            pub fn rectFill(self: @This()) z2d.Pixel {
                return self.alphaPixel(96);
            }

            /// The border color for rectangles.
            pub fn rectBorder(self: @This()) z2d.Pixel {
                return self.alphaPixel(200);
            }

            /// The raw RGB as a pixel.
            pub fn pixel(self: @This()) z2d.Pixel {
                return self.rgb().asPixel();
            }

            fn alphaPixel(self: @This(), alpha: u8) z2d.Pixel {
        ...
        pub fn init(alloc: Allocator, sz: Size) Self.InitError!Self {
        ...
        pub fn pendingImage(self: *const Self) Self.PendingImage {
            return .{
        ...
        fn highlightHyperlinks(
            ...
            const border_color = Self.Color.hyperlink.rectBorder();
            const fill_color = Self.Color.hyperlink.rectFill();
        ...
        fn highlightSemanticPrompts(
            ...
            {
                const prompt_border = Self.Color.semantic_prompt.rectBorder();
                const prompt_fill = Self.Color.semantic_prompt.rectFill();
            ...
            for (row_cells, 0..) |cells, y| {
                ...
                while (x < raw_cells.len) {
                    ...
                    const color: Self.Color = switch (content) {
...
pub const Overlay = OverlayModule();
pub const Color = Overlay.Color;
pub const PendingImage = Overlay.PendingImage;
pub const Feature = Overlay.Feature;
pub const InitError = Overlay.InitError;
