...
const software_renderer_cpu_shader_reprobe_interval_frames_help =
    "CPU software renderer custom-shader capability reprobe interval in frames (u16). 0=disable periodic reprobe after initial capability evaluation. Default: 120.";
...
software_renderer_cpu_shader_reprobe_interval_frames: u16 = 120,
...
pub fn init(b: *std.Build, appVersion: []const u8) !Config {
    ...
    config.software_renderer_cpu_shader_reprobe_interval_frames = b.option(
        u16,
        "software-renderer-cpu-shader-reprobe-interval-frames",
        software_renderer_cpu_shader_reprobe_interval_frames_help,
    ) orelse 120;
...
pub fn addOptions(self: *const Config, step: *std.Build.Step.Options) !void {
    ...
    step.addOption(
        u16,
        "software_renderer_cpu_shader_reprobe_interval_frames",
        self.software_renderer_cpu_shader_reprobe_interval_frames,
    );
    step.addOption(
        bool,
...
pub fn fromOptions() Config {
    ...
    const result: Config = .{
        ...
        .software_renderer_cpu_shader_reprobe_interval_frames = options.software_renderer_cpu_shader_reprobe_interval_frames,
